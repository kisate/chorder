...
input_device = 0         # Which recording device to use. On my system Stereo Mix = 1
...
for i in range(0, numdevices):
        if (audio.get_device_info_by_host_api_device_index(0, i).get('maxInputChannels')) > 0:
            print ("Input Device id {} - {}".format(i, audio.get_device_info_by_host_api_device_index(0, i).get('name')))
